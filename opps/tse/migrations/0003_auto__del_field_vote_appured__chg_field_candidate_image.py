...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vote.appured'
        db.delete_column(u'tse_vote', 'appured')


        # Changing field 'Candidate.image'
        db.alter_column(u'tse_candidate', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'Vote.appured'
        db.add_column(u'tse_vote', 'appured',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Candidate.image'
        db.alter_column(u'tse_candidate', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))
