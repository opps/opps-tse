...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.total_appured_electorate'
        db.add_column(u'tse_election', 'total_appured_electorate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.total_not_appured_electorate'
        db.add_column(u'tse_election', 'total_not_appured_electorate',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.total_appured_electorate'
        db.delete_column(u'tse_election', 'total_appured_electorate')

        # Deleting field 'Election.total_not_appured_electorate'
        db.delete_column(u'tse_election', 'total_not_appured_electorate')
    ...
    models = {
        ...
        u'tse.election': {
            ...
            'total_appured_electorate': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'total_not_appured_electorate': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
